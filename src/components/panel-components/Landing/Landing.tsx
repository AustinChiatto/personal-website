    ...
    return (
        <>
            <div className={styles.personalIntro}>
                ...
                <Typography>
                    Recently I completed an internship at {dovetailLink} where I built a website
                    using Next.js that introduces their {marketMaestroLink} application.
                </Typography>
                <Typography>
